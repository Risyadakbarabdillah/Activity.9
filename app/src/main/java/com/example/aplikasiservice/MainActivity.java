...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMenitRadio = findViewById(R.id.RadioB1);
        mLimaRadio = findViewById(R.id.RadioB2);
        mTigaPuluhRadio = findViewById(R.id.RadioB3);
        mJamRadio = findViewById(R.id.RadioB4);
        mTimeRadioGroup = findViewById(R.id.radioG1);
